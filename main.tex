...
Conceitos de Qualidade (Algumas etapas para garantir a qualidade do software) 
        ...
        \item Qualidadede do projeto: as características que os projetistas especificam para um item. 
        \item Inclui: requisitos, especificações e concepção do sistema. 
        ...
        Abordagens de implementação: 
            \item Totalmente automatizado 
            \item Inteiramente manual 
            \item Combinação de ferramentas automatizadas e interações humanas 
       ...
       A garantia de qualidade consiste em: Função de auditoria e reporte para suportar o gerenciamento 
            ...
            Objetivo: 
            \item promover o gerenciamento dos dados necessários para a qualidade do produto; 
            \item Obter a percepção e a confiança da qualidade do produto.
       Custo da Qualidade 
       ...
       Custo da qualidade inclui: 
            ...
            \item Custo de avaliação: 
                ...
                \item testes 
            \item custo de falha:
                \item Custo de falha interna: Retrabalho, reparo e Análise de Modos de Falhas e Efeitos

            \item Custo de falha externa: 
                \item Resolução de queixas 
                \tem Retorno e substituição do produto 
        ...
        Três pontos de importância para a medição da qualidade: 
            \item utilizar exigências como a base; 
            \item utilizar normas especificadas como os critérios; 
            \item considerar os requisitos implícitos.
        
        Sobre a garantia de qualidade: 
            \item A primeira garantia formal de qualidade e função de controle, foi introduzido no mundo da produção no Bell Labs em 1916. 
            \item Durante os anos 1950 e 1960, os programadores controlaram a qualidade do produto. 
            \item Durante os anos 1970, as normas de garantia de qualidade foram introduzidas primeiramente em contratos militares de desenvolvimento de software. 
            \item Em 1987,uma definição estendida é dada em (SCH87). Software Reviews
        ...
        Por que revisões de software? 
            \item Errar é humano 
            \item É fácil pegar os erros no trabalho dos engenheiros 

        Uma revisão é uma forma de: 
            \item Identificar as melhorias necessárias das partes de um produto 
            \item Confirmar as melhorias nas partes de um produto
            \item Realizar um trabalho técnico mais uniforme, previsível e gerenciável. 

        Diferentes tipos de Revisões: 
            \item Revisões informais: reunião informal e recepção informal de verificação 
            \item Revisões formais: (para uma plateia de clientes, gestores e pessoal). Passo a passo, inspeção e revisões round-robin (ciclos) 
        ...
        Proposta da FTR: 
            \item Servir como um campo de treinamento para engenheiros juniores (lições aprendidas) 
            \item Promover o backup e continuidade 

        Restrições da reunião de Revisões: 
            \item 3 a 5 pessoas envolvidas em um comentário 
            \item Preparação avançada (não mais do que 2 horas para cada pessoa) 
            \item A duração da reunião de análise deve ser inferior a 2 horas 
            \item Concentrar em uma parte específica de um produto de software 

        As pessoas envolvidas em uma reunião de revisão: Produtor, líder de revisão, 2 ou 3 avaliadores ( um deles é o gravador) 

        Reunião Formal de Análise Técnica 
        A preparação de uma reunião de avaliação: 
            \item Agenda e horário da reunião (pelo avaliador líder) 
            \item Material de revisão e distribuição (pelo produtor) 
            \item Revisão com antecedência (pelos avaliadores) 

        Resultados da reunião de Revisões: 
            \item Uma revisão da lista de problemas 
            \item Uma revisão simples do relatório sintético (chamado de atas de reuniões) 

        As decisões da reunião: 
            \item Aceitar o produto do trabalho e ou modificação adicional 
            \item Rejeitar o produto do trabalho devido a erros 
            \item Aceitar o trabalho sob condições (por exemplo, mudança e revisão) 
            \item Folha de sign-off
            
        Relatório sintético da Revisão (um registro histórico do projeto) responde às seguintes perguntas: 
            \item O que foi revisado? 
            \item Quem analisou isso? 
            \item Quais foram os resultados e conclusões 

        Revisão da lista de problemas serve a dois propósitos: 
            \item Para identificar áreas problemáticas no projeto 
            \item Para servir como um check-list de itens para ação (é necessário um processo de follow- up) 
        ...
        Garantia de qualidade estatística implica nas seguintes etapas: 
            \item Informações sobre defeitos de software são coletadas e categorizadas 
            \item É feita uma tentativa de rastrear cada defeito na sua causa raiz 
            \item Usando o princípio de Pareto (80 por cento dos defeitos podem ser rastreados para 20 por cento, e isolar os 20 por cento) 
            \item Uma vez que as poucas causas vitais foram identificados, corrigir os defeitos. 
        ...
        Causas de erros: 
            ...
            \item Erro na lógica do design (EDL) 
